...
import org.example.behavioralPattern.iterator.iterator.FacebookIterator;
...
public class Facebook implements SocialNetwork{
    ...
    public List<String> requestProfileFriendFromFacebook(String profileEmail, String contactType){
        simulateNetworkLatency();
